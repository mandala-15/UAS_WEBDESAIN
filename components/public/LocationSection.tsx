    ...
    <section id="lokasi" className="scroll-mt-28">
      <div className="mx-auto max-w-7xl px-4 py-14">
        <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-stretch">
          <FadeIn className="flex flex-col justify-center rounded-[24px] bg-[#064E3B] p-5 text-white shadow-[0_28px_80px_rgba(6,78,59,0.22)] sm:rounded-[30px] sm:p-6 md:p-8">
            <p className="text-sm font-semibold text-yellow-200">Lokasi Masjid</p>
            <h2 className="mt-3 text-2xl font-semibold sm:text-3xl md:text-4xl">Lokasi Masjid Mitfhaul Jannah</h2>
            ...
            <div className="mt-6 rounded-2xl border border-white/12 bg-white/10 p-4">
              ...
              <p className="mt-2 break-words text-base font-semibold sm:text-lg">Jalan Budi Daya Gang Bayu</p>
          ...
          <FadeIn delay={0.1} className="overflow-hidden rounded-[24px] border border-slate-200 bg-white shadow-[0_22px_70px_rgba(15,23,42,0.08)] sm:rounded-[30px]">
            <div className="relative min-h-[320px] bg-[linear-gradient(135deg,rgba(6,78,59,0.92),rgba(5,150,105,0.72)),url('https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&w=1400&q=80')] bg-cover bg-center sm:min-h-[360px]">
              <div className="absolute inset-0 portal-pattern opacity-20" />
              <div className="absolute left-1/2 top-1/2 w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 rounded-[22px] border border-white/24 bg-white/14 p-4 text-white shadow-[0_22px_70px_rgba(0,0,0,0.24)] backdrop-blur-xl sm:w-[82%] sm:rounded-[28px] sm:p-5 md:w-[68%]">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <h3 className="mt-1 text-xl font-semibold sm:text-2xl">Masjid Mitfhaul Jannah</h3>
